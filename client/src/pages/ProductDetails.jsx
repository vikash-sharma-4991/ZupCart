        ...
        <div className="mt-12">
            ...
            <div className='flex flex-col items-center mt-20'>
                <div className='flex flex-col items-center w-max'>
                    ...
                    <div className='w-40 h-0.5 bg-primary rounded-full mt-2'></div>
                </div>
                ...
                <button onClick={()=> {navigate("/products"); scrollTo(0,0)}} className='mx-auto cursor-pointer px-12 py-2.5 my-16 border rounded text-primary hover:bg-primary/10 transition'>See More</button>
            </div>
        </div>
    );
}
